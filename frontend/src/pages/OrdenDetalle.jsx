            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`rounded-lg border px-3 py-1.5 text-xs font-medium transition-colors ${tipoItem === 'producto' ? 'border-orange-600 bg-orange-600 text-white' : 'border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                >
                ...
                <button
                  ...
                  className={`rounded-lg border px-3 py-1.5 text-xs font-medium transition-colors ${tipoItem === 'mano_obra' ? 'border-orange-600 bg-orange-600 text-white' : 'border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                >
                  Mano de obra / libre
                </button>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              {puedeAbrirGarantia && (
                <button
                  ...
                  className={`${btnWarning} inline-flex items-center gap-1.5 px-3 py-1.5 text-sm`}
                >
